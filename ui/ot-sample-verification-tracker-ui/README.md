...
This is a very basic angular app that just showcases a sample entry form and the list of samples already entered. I didn't want to overcomplicate it by introducing more of advanced concepts like ngrx stores whcih would be overengineering it. Also, I concentrated only on the main functionality and not much on the UX or UI looks.
